 ...
 * venta de productos. Contendra un listado de productos de
...
public interface IMercado {
	 ...
	 * en el registro de productos, se a�adira, y el metodo devuelve true.
	 * 
	 ...
	 * 
	 * La clase que implemente IMercado tiene que tener una estructura de almacenamiento
	 * para poder subir el producto que se desea subir.
	 * 
	 ...
	 * casuistica. No hay productos que valgan null, por lo que 
	 * no hay que controlar esta casuistica tampoco.
	 * 
	 * 
	 ...
	 * del registro general de productos. Ademas retorna el Usuario que era
	 * dueño de dicho producto. 
	 * 
	 * Devolvera null,
	 ...
	 * de productos. Se devuelve como resultado el usuario propietario del producto.
	 * 
	 * @return IUsuario. Usuario propietario del producto que se ha eliminado. En caso de que no exista ningun
